    ...
    def populate_teams(cls):
        ...
        for game in games:
            ...
            if home_team_existence_check is None:
                nflTeam = nflTeamModel(home_team_info['teamId'], home_team_info['abbr'], home_team_info['cityState'],
            ...
            if away_team_existence_check is None:
                nflTeam = nflTeamModel(away_team_info['teamId'], away_team_info['abbr'], away_team_info['cityState'],
