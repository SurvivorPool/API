...
class AdminMessage(Resource):
    ...
    parser.add_argument('message_text', type=str, required=True, help='message_text cannot be null')
    parser.add_argument('show_message', type=bool, help='show_message cannot be null')
    parser.add_argument('message_type', type=str, required=True, help='message_type cannot be null')
    ...
    def put(self):
        ...
        if message is None:
            message = AdminMessageModel(data['user_id'], data['message_text'], data['show_message'], data['message_type'])
        else:
